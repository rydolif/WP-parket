...
?>
	...
	<div class="hero">
		<div class="container">
			...
			<a href="<?php echo get_home_url(); ?>/product/" class="btn btn--red">Выбрать</a>
		...
		<div class="container">
			...
			<div id="one" class="tabs__wrap">
				...
				<div class="cart">
					<div class="cart__img swiper-container">
						<div class="swiper-wrapper">
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart1.png" data-fancybox="gallery" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/cart1.png" alt="">
							</a>
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart2.png" data-fancybox="gallery" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/cart2.png" alt="">
							</a>
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart3.png" data-fancybox="gallery" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/cart3.png" alt="">
							</a>
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart4.png" data-fancybox="gallery" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/cart4.png" alt="">
							</a>
						</div>
						...
						<div class="cart__block">
							...
							<p>
								<span class="cart__block_white">Популярное</span>
								<span class="cart__block_sale">Sale</span>
							</p>
						</div>
					</div>
					<h4>Паркетная доска Дуб арктик 012345678</h4>
					<div class="cart__info">
						<p>
							<span>Цена</span>
							<b>
								<span class="cart__info_old">2 300 руб./м<sup>2</sup></span>
								<span class="cart__info_price">1 230 </span>руб./м<sup>2</sup>
							</b>
						</p>
						<p>
							<span>Класс</span>
					...
					<form class="cart__form">
						...
						<div class="cart__form_block">
							<p>Площадь покрытия (м<sup>2</sup>)</p>
							<div class="cart__form_quantity">
								<a href="#">-</a>
								<input type="text" value="1">
								<a href="#">+</a>
						...
						<p class="cart__price">
							...
							<span class="cart__price_green"><b>1 230</b> руб.</span>
						</p>
					</form>
				...
				<div class="cart">
					<div class="cart__img swiper-container">
						<div class="swiper-wrapper">
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart2.png" data-fancybox="gallery1" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
				...
				<div class="cart">
					<div class="cart__img swiper-container">
						<div class="swiper-wrapper">
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart3.png" data-fancybox="gallery2" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
							...
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart4.png" data-fancybox="gallery2" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
				...
				<div class="cart">
					<div class="cart__img swiper-container">
						<div class="swiper-wrapper">
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart1.png" data-fancybox="gallery3" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
							...
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart2.png" data-fancybox="gallery3" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
							...
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart3.png" data-fancybox="gallery3" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
							...
							<a href="<?php echo get_template_directory_uri(); ?>/assets/img/cart4.png" data-fancybox="gallery3" class="swiper-slide">
								<span class="cart__img_plus">
									<span></span>
									<span></span>
								</span>
			...
			<div class="tabs__btn">
				<a href="#" class="btn btn--cart">Еще</a>
			</div>
